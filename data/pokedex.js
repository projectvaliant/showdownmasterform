...
let BattlePokedex = {
	...
	venusaur: {
		...
		types: ["Grass", "Poison"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 82, def: 83, spa: 110, spd: 100, spe: 81},
		abilities: {0: "Overgrow", H: "Chlorophyll"},
		heightm: 2,
		weightkg: 100,
		color: "Green",
	...
	charizard: {
		...
		types: ["Fire", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 78, atk: 84, def: 78, spa: 109, spd: 85, spe: 102},
		abilities: {0: "Blaze", H: "Solar Power"},
		heightm: 1.7,
		weightkg: 90.5,
		color: "Red",
	...
	blastoise: {
		...
		types: ["Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 84, atk: 83, def: 101, spa: 85, spd: 105, spe: 78},
		abilities: {0: "Torrent", H: "Rain Dish"},
		heightm: 1.6,
		weightkg: 85.5,
		color: "Blue",
	...
	caterpie: {
		...
		abilities: {0: "Shield Dust", H: "Instinct"},
		heightm: 0.3,
		weightkg: 2.9,
		color: "Green",
		evos: ["metapod"],
	...
	rattata: {
		...
		abilities: {0: "Instinct", 1: "Guts", H: "Hustle"},
		heightm: 0.3,
		weightkg: 3.5,
		color: "Purple",
		evos: ["raticate"],
	...
	pikachu: {
		...
		species: "Pikachu",
		types: ["Electric"],
		baseStats: {hp: 35, atk: 55, def: 40, spa: 50, spd: 50, spe: 96},
		abilities: {0: "Static", 1: "Super Luck", H: "Lightning Rod"},
		heightm: 0.4,
		weightkg: 6,
		color: "Yellow",
		prevo: "pichu",
	...
	pikachucosplay: {
		...
		types: ["Electric"],
		gender: "F",
		baseStats: {hp: 35, atk: 55, def: 40, spa: 50, spd: 50, spe: 126},
	...
	pikachurockstar: {
		...
		gender: "F",
		baseStats: {hp: 35, atk: 75, def: 50, spa: 50, spd: 50, spe: 96},
		abilities: {0: "Moxie"},
		heightm: 0.4,
		weightkg: 6,
		color: "Yellow",
	...
	pikachubelle: {
		...
		types: ["Electric", "Ice"],
		gender: "F",
		baseStats: {hp: 35, atk: 55, def: 40, spa: 70, spd: 50, spe: 106},
	...
	pikachupopstar: {
		...
		gender: "F",
		baseStats: {hp: 55, atk: 55, def: 40, spa: 50, spd: 50, spe: 96},
	...
	pikachuphd: {
		...
		gender: "F",
		baseStats: {hp: 35, atk: 55, def: 40, spa: 70, spd: 50, spe: 101},
	...
	pikachulibre: {
		...
		types: ["Electric"],
		gender: "F",
		baseStats: {hp: 35, atk: 85, def: 40, spa: 50, spd: 50, spe: 96},
	...
	oddish: {
		...
		abilities: {0: "Chlorophyll", H: "Instinct"},
		heightm: 0.5,
		weightkg: 5.4,
		color: "Blue",
		evos: ["gloom"],
	...
	venonat: {
		...
		abilities: {0: "Compound Eyes", 1: "Tinted Lens", H: "Instinct"},
		heightm: 1,
		weightkg: 30,
		color: "Purple",
		evos: ["venomoth"],
	...
	ponyta: {
		...
		abilities: {0: "Instinct", 1: "Flash Fire", H: "Flame Body"},
		heightm: 1,
		weightkg: 30,
		color: "Yellow",
		evos: ["rapidash"],
	...
	farfetchd: {
		...
		abilities: {0: "Speed Boost", 1: "Sniper", H: "Defiant"},
		heightm: 0.8,
		weightkg: 15,
		color: "Brown",
	...
	doduo: {
		...
		abilities: {0: "Instinct", 1: "Early Bird", H: "Tangled Feet"},
		heightm: 1.4,
		weightkg: 39.2,
		color: "Brown",
		evos: ["dodrio"],
	...
	gastly: {
		...
		abilities: {0: "Levitate", 1: "Bad Dreams"},
		heightm: 1.3,
		weightkg: 0.1,
		color: "Purple",
		evos: ["haunter"],
	...
	gengar: {
		...
		abilities: {0: "Cursed Body", 1: "Bad Dreams"},
		heightm: 1.5,
		weightkg: 40.5,
		color: "Purple",
		prevo: "haunter",
	...
	onix: {
		...
		species: "Onix",
		types: ["Rock", "Ground"],
		baseStats: {hp: 55, atk: 45, def: 160, spa: 30, spd: 45, spe: 70},
	...
	hitmonlee: {
		...
		abilities: {0: "Comeback", 1: "Reckless", H: "Unburden"},
		heightm: 1.5,
		weightkg: 49.8,
		color: "Brown",
		prevo: "tyrogue",
	...
	hitmonchan: {
		...
		abilities: {0: "Comeback", 1: "Iron Fist", H: "Inner Focus"},
		heightm: 1.4,
		weightkg: 50.2,
		color: "Brown",
		prevo: "tyrogue",
	...
	seaking: {
		...
		abilities: {0: "Swift Swim", 1: "Comeback", H: "Lightning Rod"},
		heightm: 1.3,
		weightkg: 39,
		color: "Red",
		prevo: "goldeen",
	...
	electabuzz: {
		...
		types: ["Electric"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 65, atk: 88, def: 57, spa: 105, spd: 75, spe: 125},
		abilities: {0: "Static", 1: "Technician", H: "Vital Spirit"},
		heightm: 1.1,
		weightkg: 30,
		color: "Yellow",
		prevo: "elekid",
	...
	magmar: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 65, atk: 105, def: 57, spa: 100, spd: 75, spe: 113},
	...
	ditto: {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: {hp: 60, atk: 60, def: 60, spa: 60, spd: 60, spe: 48},
	...
	eevee: {
		...
		abilities: {0: "Instinct", 1: "Adaptability", H: "Anticipation"},
		heightm: 0.3,
		weightkg: 6.5,
		color: "Brown",
	...
	vaporeon: {
		...
		abilities: {0: "Water Absorb", 1: "Storm Drain", H: "Hydration"},
		heightm: 1,
		weightkg: 29,
		color: "Blue",
		prevo: "eevee",
	...
	jolteon: {
		...
		abilities: {0: "Volt Absorb", 1: "Lighting Rod", H: "Quick Feet"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: "eevee",
	...
	sentret: {
		...
		abilities: {0: "Instinct", 1: "Keen Eye", H: "Frisk"},
		heightm: 0.8,
		weightkg: 6,
		color: "Brown",
		evos: ["furret"],
	...
	aipom: {
		...
		abilities: {0: "Instinct", 1: "Pickup", H: "Skill Link"},
		heightm: 0.8,
		weightkg: 11.5,
		color: "Purple",
		evos: ["ambipom"],
	...
	sunflora: {
		...
		species: "Sunflora",
		types: ["Grass"],
		baseStats: {hp: 85, atk: 75, def: 55, spa: 115, spd: 85, spe: 50},
	...
	umbreon: {
		...
		abilities: {0: "Synchronize", 1: "Filter", H: "Inner Focus"},
		heightm: 1,
		weightkg: 27,
		color: "Black",
		prevo: "eevee",
	...
	wobbuffet: {
		...
		species: "Wobbuffet",
		types: ["Psychic"],
		baseStats: {hp: 200, atk: 33, def: 58, spa: 33, spd: 58, spe: 33},
	...
	girafarig: {
		...
		abilities: {0: "Inner Focus", 1: "Strong Jaw", H: "Sap Sipper"},
		heightm: 1.5,
		weightkg: 41.5,
		color: "Yellow",
		eggGroups: ["Field"],
	...
	dunsparce: {
		...
		species: "Dunsparce",
		types: ["Normal", "Fairy"],
		baseStats: {hp: 110, atk: 75, def: 75, spa: 75, spd: 75, spe: 45},
		abilities: {0: "Serene Grace", 1: "Thick Fat", H: "Rattled"},
		heightm: 1.5,
		weightkg: 14,
		color: "Yellow",
		eggGroups: ["Field"],
	...
	snubbull: {
		...
		abilities: {0: "Intimidate", 1: "Instinct", H: "Rattled"},
		heightm: 0.6,
		weightkg: 7.8,
		color: "Pink",
		evos: ["granbull"],
	...
	qwilfish: {
		...
		species: "Qwilfish",
		types: ["Water", "Poison"],
		baseStats: {hp: 75, atk: 95, def: 85, spa: 55, spd: 65, spe: 85},
	...
	heracrossmega: {
		...
		formeLetter: "M",
		types: ["Bug", "Fighting"],
		baseStats: {hp: 80, atk: 185, def: 125, spa: 40, spd: 105, spe: 75},
	...
	corsola: {
		...
		types: ["Water", "Rock"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 65, atk: 75, def: 105, spa: 75, spd: 95, spe: 35},
		abilities: {0: "Skill Link", 1: "Natural Cure", H: "Regenerator"},
		heightm: 0.6,
		weightkg: 5,
		color: "Pink",
		eggGroups: ["Water 1", "Water 3"],
	...
	hitmontop: {
		...
		abilities: {0: "Intimidate", 1: "Technician", H: "Comeback"},
		heightm: 1.4,
		weightkg: 48,
		color: "Brown",
		prevo: "tyrogue",
	...
	treecko: {
		...
		abilities: {0: "Overgrow", 1: "Mold Breaker", H: "Unburden"},
		heightm: 0.5,
		weightkg: 5,
		color: "Green",
		evos: ["grovyle"],
	...
	sceptile: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 85, def: 65, spa: 105, spd: 85, spe: 126},
		abilities: {0: "Overgrow", 1: "Mold Breaker", H: "Unburden"},
		heightm: 1.7,
		weightkg: 52.2,
		color: "Green",
	...
	blaziken: {
		...
		types: ["Fire", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 120, def: 70, spa: 116, spd: 70, spe: 80},
		abilities: {0: "Blaze", H: "Speed Boost"},
		heightm: 1.9,
		weightkg: 52,
		color: "Red",
	...
	swampert: {
		...
		types: ["Water", "Ground"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 101, atk: 110, def: 90, spa: 85, spd: 90, spe: 60},
		abilities: {0: "Torrent", 1: "Regenerator", H: "Damp"},
		heightm: 1.5,
		weightkg: 81.9,
		color: "Blue",
	...
	poochyena: {
		...
		abilities: {0: "Instinct", 1: "Quick Feet", H: "Rattled"},
		heightm: 0.5,
		weightkg: 13.6,
		color: "Gray",
		evos: ["mightyena"],
	...
	seedot: {
		...
		abilities: {0: "Chlorophyll", 1: "Filter", H: "Pickpocket"},
		heightm: 0.5,
		weightkg: 4,
		color: "Brown",
		evos: ["nuzleaf"],
	...
	shiftry: {
		...
		abilities: {0: "Chlorophyll", 1: "Aerilate", H: "Pickpocket"},
		heightm: 1.3,
		weightkg: 59.6,
		color: "Brown",
		prevo: "nuzleaf",
	...
	nincada: {
		...
		abilities: {0: "Compound Eyes", H: "Instinct"},
		heightm: 0.5,
		weightkg: 5.5,
		color: "Gray",
	...
	shedinja: {
		...
		types: ["Bug", "Ghost"],
		gender: "N",
		baseStats: {hp: 75, atk: 90, def: 65, spa: 70, spd: 60, spe: 70},
		abilities: {0: "Wonder Guard", 1: "Illusion", H: "Levitate"},
		heightm: 0.8,
		weightkg: 1.2,
		color: "Brown",
		prevo: "nincada",
	...
	skitty: {
		...
		types: ["Normal", "Grass"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 50, atk: 55, def: 45, spa: 55, spd: 35, spe: 70},
		abilities: {0: "Cute Charm", 1: "Natural Cure", H: "Wonder Skin"},
		heightm: 0.6,
		weightkg: 11,
		color: "Pink",
		evos: ["delcatty"],
	...
	delcatty: {
		...
		types: ["Normal", "Grass"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 70, atk: 75, def: 65, spa: 75, spd: 55, spe: 90},
		abilities: {0: "Cute Charm", 1: "Natural Cure", H: "Wonder Skin"},
		heightm: 1.1,
		weightkg: 32.6,
		color: "Purple",
	...
	plusle: {
		...
		species: "Plusle",
		types: ["Electric"],
		baseStats: {hp: 60, atk: 50, def: 40, spa: 95, spd: 75, spe: 110},
		abilities: {0: "Plus", 1: "Klutz", H: "Lightning Rod"},
		heightm: 0.4,
		weightkg: 4.2,
		color: "Yellow",
		eggGroups: ["Fairy"],
	...
	minun: {
		...
		species: "Minun",
		types: ["Electric"],
		baseStats: {hp: 60, atk: 40, def: 75, spa: 75, spd: 85, spe: 95},
		abilities: {0: "Minus", 1: "Frisk", H: "Volt Absorb"},
		heightm: 0.4,
		weightkg: 4.2,
		color: "Yellow",
		eggGroups: ["Fairy"],
	...
	volbeat: {
		...
		types: ["Bug"],
		gender: "M",
		baseStats: {hp: 75, atk: 73, def: 75, spa: 47, spd: 85, spe: 85},
		abilities: {0: "Tinted Lens", 1: "Frisk", H: "Prankster"},
		heightm: 0.7,
		weightkg: 17.7,
		color: "Gray",
	...
	illumise: {
		...
		types: ["Bug"],
		gender: "F",
		baseStats: {hp: 65, atk: 47, def: 75, spa: 73, spd: 95, spe: 85},
		abilities: {0: "Unaware", 1: "Tinted Lens", H: "Prankster"},
		heightm: 0.6,
		weightkg: 17.7,
		color: "Purple",
		eggGroups: ["Bug", "Human-Like"],
	...
	gulpin: {
		...
		abilities: {0: "Liquid Ooze", 1: "Gooey", H: "Gluttony"},
		heightm: 0.4,
		weightkg: 10.3,
		color: "Green",
		evos: ["swalot"],
	...
	sharpedo: {
		...
		abilities: {0: "Rough Skin", 1: "Fear", H: "Speed Boost"},
		heightm: 1.8,
		weightkg: 88.8,
		color: "Blue",
		prevo: "carvanha",
	...
	spinda: {
		...
		abilities: {0: "Own Tempo", 1: "Tipsy", H: "Contrary"},
		heightm: 1.1,
		weightkg: 5,
		color: "Brown",
	...
	seviper: {
		...
		abilities: {0: "Shed Skin", 1: "Tinted Lens", H: "Infiltrator"},
		heightm: 2.7,
		weightkg: 52.5,
		color: "Black",
		eggGroups: ["Field", "Dragon"],
	...
	castformsunny: {
		...
		formeLetter: "S",
		types: ["Fire"],
		baseStats: {hp: 70, atk: 70, def: 70, spa: 120, spd: 70, spe: 120},
		abilities: {0: "Forecast"},
		heightm: 0.3,
		weightkg: 0.8,
		color: "Red",
	...
	castformrainy: {
		...
		formeLetter: "R",
		types: ["Water"],
		baseStats: {hp: 90, atk: 70, def: 110, spa: 70, spd: 110, spe: 70},
		abilities: {0: "Forecast"},
		heightm: 0.3,
		weightkg: 0.8,
		color: "Blue",
	...
	castformsnowy: {
		...
		formeLetter: "S",
		types: ["Ice"],
		baseStats: {hp: 85, atk: 90, def: 85, spa: 90, spd: 85, spe: 85},
		abilities: {0: "Forecast"},
		heightm: 0.3,
		weightkg: 0.8,
		color: "White",
	...
	tropius: {
		...
		species: "Tropius",
		types: ["Grass", "Flying"],
		baseStats: {hp: 119, atk: 78, def: 83, spa: 92, spd: 87, spe: 51},
	...
	glaliemega: {
		...
		formeLetter: "M",
		types: ["Ice"],
		baseStats: {hp: 90, atk: 120, def: 90, spa: 120, spd: 90, spe: 120},
	...
	huntail: {
		...
		abilities: {0: "Swift Swim", H: "Big Jaw"},
		heightm: 1.7,
		weightkg: 27,
		color: "Blue",
		prevo: "clamperl",
	...
	gorebyss: {
		...
		abilities: {0: "Water Bubble", H: "Hydration"},
		heightm: 1.8,
		weightkg: 22.6,
		color: "Pink",
		prevo: "clamperl",
	...
	luvdisc: {
		...
		types: ["Water"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 43, atk: 30, def: 55, spa: 75, spd: 65, spe: 107},
	...
	torterra: {
		...
		types: ["Grass", "Ground"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 104, atk: 109, def: 105, spa: 75, spd: 87, spe: 56},
		abilities: {0: "Overgrow", H: "Shell Armor"},
		heightm: 2.2,
		weightkg: 310,
		color: "Green",
	...
	infernape: {
		...
		types: ["Fire", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 76, atk: 104, def: 71, spa: 104, spd: 71, spe: 110},
		abilities: {0: "Blaze", H: "Iron Fist"},
		heightm: 1.2,
		weightkg: 55,
		color: "Brown",
	...
	empoleon: {
		...
		types: ["Water", "Steel"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 90, atk: 86, def: 88, spa: 111, spd: 101, spe: 60},
		abilities: {0: "Torrent", H: "Defiant"},
		heightm: 1.7,
		weightkg: 84.5,
		color: "Blue",
	...
	kricketot: {
		...
		abilities: {0: "Shed Skin", H: "Instinct"},
		heightm: 0.3,
		weightkg: 2.2,
		color: "Red",
		evos: ["kricketune"],
	...
	wormadamsandy: {
		...
		types: ["Bug", "Ground"],
		gender: "F",
		baseStats: {hp: 60, atk: 79, def: 105, spa: 59, spd: 105, spe: 36},
		abilities: {0: "Anticipation", H: "Overcoat"},
		heightm: 0.5,
		weightkg: 6.5,
		color: "Brown",
	...
	wormadamtrash: {
		...
		types: ["Bug", "Steel"],
		gender: "F",
		baseStats: {hp: 60, atk: 69, def: 115, spa: 69, spd: 95, spe: 36},
		abilities: {0: "Anticipation", H: "Overcoat"},
		heightm: 0.5,
		weightkg: 6.5,
		color: "Red",
	...
	pachirisu: {
		...
		species: "Pachirisu",
		types: ["Electric", "Fairy"],
		baseStats: {hp: 60, atk: 55, def: 70, spa: 55, spd: 90, spe: 105},
		abilities: {0: "Friend Guard", 1: "Harvest", H: "Volt Absorb"},
		heightm: 0.4,
		weightkg: 3.9,
		color: "White",
		eggGroups: ["Field", "Fairy"],
	...
	cherrim: {
		...
		baseForme: "Overcast",
		types: ["Grass"],
		baseStats: {hp: 70, atk: 60, def: 80, spa: 87, spd: 88, spe: 85},
	...
	cherrimsunshine: {
		...
		formeLetter: "S",
		types: ["Grass"],
		baseStats: {hp: 70, atk: 60, def: 70, spa: 117, spd: 78, spe: 115},
		abilities: {0: "Flower Gift"},
		heightm: 0.5,
		weightkg: 9.3,
		color: "Pink",
	...
	ambipom: {
		...
		abilities: {0: "Technician", 1: "Comeback", H: "Skill Link"},
		heightm: 1.2,
		weightkg: 20.3,
		color: "Purple",
		prevo: "aipom",
	...
	buneary: {
		...
		abilities: {0: "Instinct", 1: "Klutz", H: "Limber"},
		heightm: 0.4,
		weightkg: 5.5,
		color: "Brown",
		evos: ["lopunny"],
	...
	chatot: {
		...
		species: "Chatot",
		types: ["Normal", "Flying"],
		baseStats: {hp: 76, atk: 65, def: 45, spa: 102, spd: 42, spe: 91},
		abilities: {0: "Keen Eye", 1: "Tangled Feet", H: "Big Pecks"},
		heightm: 0.5,
		weightkg: 1.9,
		color: "Black",
	...
	spiritomb: {
		...
		abilities: {0: "Pressure", 1: "Tinted Lens", H: "Infiltrator"},
		heightm: 1,
		weightkg: 108,
		color: "Purple",
		eggGroups: ["Amorphous"],
	...
	lucariomega: {
		...
		types: ["Fighting", "Steel"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 145, def: 88, spa: 145, spd: 70, spe: 112},
		abilities: {0: "Adaptability"},
		heightm: 1.3,
		weightkg: 57.5,
		color: "Blue",
	...
	carnivine: {
		...
		abilities: {0: "Levitate", H: "Comeback"},
		heightm: 1.4,
		weightkg: 27,
		color: "Green",
		eggGroups: ["Grass"],
	...
	electivire: {
		...
		types: ["Electric"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 75, atk: 133, def: 77, spa: 95, spd: 85, spe: 95},
	...
	gallade: {
		...
		abilities: {0: "Steadfast", 1: "Comeback", H: "Justified"},
		heightm: 1.6,
		weightkg: 52,
		color: "White",
		prevo: "kirlia",
	...
	dusknoir: {
		...
		abilities: {0: "Iron Fist", 1: "Fear", H: "Frisk"},
		heightm: 2.2,
		weightkg: 106.6,
		color: "Black",
		prevo: "dusclops",
	...
	serperior: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 75, atk: 75, def: 95, spa: 75, spd: 95, spe: 121},
		abilities: {0: "Overgrow", H: "Contrary"},
		heightm: 3.3,
		weightkg: 63,
		color: "Green",
	...
	emboar: {
		...
		types: ["Fire", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 118, atk: 123, def: 65, spa: 100, spd: 65, spe: 65},
	...
	samurott: {
		...
		types: ["Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 95, atk: 108, def: 85, spa: 108, spd: 70, spe: 70},
		abilities: {0: "Torrent", H: "Shell Armor"},
		heightm: 1.5,
		weightkg: 94.6,
		color: "Blue",
	...
	patrat: {
		...
		abilities: {0: "Instinct", 1: "Keen Eye", H: "Analytic"},
		heightm: 0.5,
		weightkg: 11.6,
		color: "Brown",
		evos: ["watchog"],
	...
	lillipup: {
		...
		abilities: {0: "Vital Spirit", 1: "Pickup", H: "Instinct"},
		heightm: 0.4,
		weightkg: 4.1,
		color: "Brown",
		evos: ["herdier"],
	...
	basculin: {
		...
		abilities: {0: "Moxie", 1: "Adaptability", H: "Mold Breaker"},
		heightm: 1,
		weightkg: 18,
		color: "Green",
		eggGroups: ["Water 2"],
	...
	basculinbluestriped: {
		...
		types: ["Water"],
		baseStats: {hp: 70, atk: 92, def: 65, spa: 80, spd: 55, spe: 98},
		abilities: {0: "Sheer Force", 1: "Adaptability", H: "Mold Breaker"},
		heightm: 1,
		weightkg: 18,
		color: "Green",
		eggGroups: ["Water 2"],
	...
	beheeyem: {
		...
		species: "Beheeyem",
		types: ["Psychic"],
		baseStats: {hp: 85, atk: 75, def: 75, spa: 125, spd: 95, spe: 40},
		abilities: {0: "Telepathy", 1: "Synchronize", H: "Analytic"},
		heightm: 1,
		weightkg: 34.5,
		color: "Brown",
	...
	stunfisk: {
		...
		baseStats: {hp: 109, atk: 81, def: 84, spa: 81, spd: 99, spe: 32},
		abilities: {0: "Static", 1: "Gooey", H: "Sand Veil"},
		heightm: 0.7,
		weightkg: 11,
		color: "Brown",
		eggGroups: ["Water 1", "Amorphous"],
	...
	rufflet: {
		...
		abilities: {0: "Aerilate", 1: "Sheer Force", H: "Hustle"},
		heightm: 0.5,
		weightkg: 10.5,
		color: "White",
		evos: ["braviary"],
	...
	deino: {
		...
		abilities: {0: "Hustle", 1: "Sheer Force", H: "Intimidate"},
		heightm: 0.8,
		weightkg: 17.3,
		color: "Blue",
		evos: ["zweilous"],
	...
	chesnaught: {
		...
		types: ["Grass", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 88, atk: 113, def: 122, spa: 74, spd: 75, spe: 64},
		abilities: {0: "Overgrow", H: "Bulletproof"},
		heightm: 1.6,
		weightkg: 90,
		color: "Green",
	...
	delphox: {
		...
		types: ["Fire", "Psychic"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 75, atk: 69, def: 72, spa: 116, spd: 100, spe: 104},
		abilities: {0: "Blaze", H: "Magician"},
		heightm: 1.5,
		weightkg: 39,
		color: "Red",
	...
	aromatisse: {
		...
		species: "Aromatisse",
		types: ["Fairy", "Poison"], 
		baseStats: {hp: 111, atk: 72, def: 72, spa: 99, spd: 99, spe: 29},
		abilities: {0: "Healer", H: "Aroma Veil"},
		heightm: 0.8,
		weightkg: 15.5,
		color: "Pink",
	...
	hawlucha: {
		...
		abilities: {0: "Comeback", 1: "Unburden", H: "Mold Breaker"},
		heightm: 0.8,
		weightkg: 21.5,
		color: "Green",
		eggGroups: ["Human-Like"],
	...
	lycanroc: {
		...
		abilities: {0: "Instinct", 1: "Sand Rush", H: "Steadfast"},
		heightm: 0.8,
		weightkg: 25,
		color: "Brown",
		prevo: "rockruff",
	...
	lycanrocmidnight: {
		...
		abilities: {0: "Fear", 1: "Vital Spirit", H: "No Guard"},
		heightm: 1.1,
		weightkg: 25,
		color: "Red",
		prevo: "rockruff",
	...
	wishiwashischool: {
		...
		formeLetter: "S",
		types: ["Water"],
		baseStats: {hp: 45, atk: 160, def: 160, spa: 160, spd: 135, spe: 30},
		abilities: {0: "Schooling"},
		heightm: 8.2,
		weightkg: 78.6,
		color: "Blue",
	...
	passimian: {
		...
		abilities: {0: "Receiver", 1: "Comeback", H: "Defiant"},
		heightm: 2,
		weightkg: 82.8,
		color: "White",
		eggGroups: ["Field"],
	...
	tapubulu: {
		...
		abilities: {0: "Grassy Surge", 1: "Recovery Moss", H: "Telepathy"},
		heightm: 1.9,
		weightkg: 45.5,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	colossoil: {
		...
		abilities: {0: "Comeback", 1: "Guts", H: "Unnerve"},
		heightm: 2.6,
		weightkg: 683.6,
		color: "Brown",
