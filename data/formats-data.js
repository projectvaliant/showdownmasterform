...
let BattleFormatsData = {
	...
	charizardmegax: {
		randomBattleMoves: ["dragondance", "flareblitz", "dragonclaw", "earthquake", "roost", "willowisp", "thunderpunch"],
	...
	blastoise: {
		randomBattleMoves: ["icebeam", "rapidspin", "scald", "toxic", "dragontail", "roar", "protect"],
	...
	blastoisemega: {
		randomBattleMoves: ["icebeam", "hydropump", "rapidspin", "scald", "dragontail", "darkpulse", "aurasphere", "flashcannon"],
	...
	nidoking: {
		randomBattleMoves: ["substitute", "fireblast", "icebeam", "earthpower", "sludgewave", "superpower", "earthpower", "thunderbolt"],
	...
	clefable: {
		randomBattleMoves: ["calmmind", "softboiled", "fireblast", "moonblast", "stealthrock", "thunderwave", "thunderbolt", "icebeam", "storedpower"],
	...
	crobat: {
		randomBattleMoves: ["bravebird", "roost", "toxic", "taunt", "defog", "uturn", "superfang", "crosspoison", "acrobatics", "heatwave", "sludgebomb"],
	...
	farfetchd: {
		randomBattleMoves: ["bravebird", "swordsdance", "leafblade", "roost", "knockoff", "sacredsword", "protect"],
	...
	blissey: {
		randomBattleMoves: ["toxic", "flamethrower", "seismictoss", "softboiled", "healbell", "protect", "thunderwave", "stealthrock", "icebeam", "calmmind", "thunderbolt", "defensecurl"],
	...
	kingdra: {
		randomBattleMoves: ["raindance", "hydropump", "dracometeor", "icebeam", "dragondance", "waterfall", "outrage", "ironhead"],
	...
	electivire: {
		randomBattleMoves: ["wildcharge", "drainpunch", "icepunch", "firepunch", "earthquake", "voltswitch"],
	...
	magmortar: {
		randomBattleMoves: ["flameburst", "focusblast", "hiddenpowergrass", "hiddenpowerice", "thunderbolt", "earthquake", "substitute", "darkpulse", "waterpulse"],
	...
	pinsirmega: {
		randomBattleMoves: ["swordsdance", "earthquake", "closecombat", "quickattack", "return", "stoneedge"],
	...
	tauros: {
		randomBattleMoves: ["rockclimb", "earthquake", "zenheadbutt", "rockslide", "doubleedge", "fireblast"],
	...
	ditto: {
		randomBattleMoves: ["transform", "spore", "stealthrock", "toxicspikes"],
		eventPokemon: [
	...
	vaporeon: {
		randomBattleMoves: ["wish", "protect", "scald", "roar", "icebeam", "healbell", "icebeam"],
	...
	snorlax: {
		randomBattleMoves: ["rest", "curse", "sleeptalk", "bodyslam", "earthquake", "return", "firepunch", "crunch", "pursuit", "whirlwind", "bellydrum"],
	...
	mew: {
		randomBattleMoves: ["defog", "roost", "willowisp", "knockoff", "taunt", "icebeam", "earthpower", "aurasphere", "stealthrock", "nastyplot", "psyshock", "swordsdance", "earthquake", "zenheadbutt", "drainpunch"],
	...
	furret: {
		randomBattleMoves: ["uturn", "trick", "aquatail", "firepunch", "knockoff", "doubleedge", "toxic", "wish", "cut"],
	...
	noctowl: {
		randomBattleMoves: ["roost", "whirlwind", "nightshade", "toxic", "defog", "hurricane", "heatwave", "disable"],
	...
	ledian: {
		randomBattleMoves: ["roost", "lightscreen", "encore", "reflect", "knockoff", "toxic", "uturn", "drainpunch", "icepunch", "thunderpunch"],
	...
	ariados: {
		randomBattleMoves: ["megahorn", "toxicspikes", "poisonjab", "suckerpunch", "stickyweb", "fellstinger"],
	...
	yanmega: {
		randomBattleMoves: ["bugbuzz", "airslash", "ancientpower", "uturn", "protect", "gigadrain", "dragonpulse", "dragondance", "dragonclaw", "leechlife", "steelwing"],
		tier: "UU",
		doublesTier: "(DUU)",
	},
	wooper: {
	...
	murkrow: {
		randomBattleMoves: ["substitute", "suckerpunch", "bravebird", "heatwave", "roost", "darkpulse", "thunderwave", "taunt"],
		eventPokemon: [
	...
	mismagius: {
		randomBattleMoves: ["nastyplot", "substitute", "willowisp", "shadowball", "thunderbolt", "dazzlinggleam", "taunt", "painsplit", "destinybond", "mysticfire"],
	...
	wobbuffet: {
		randomBattleMoves: ["counter", "mirrorcoat", "encore", "destinybond", "safeguard", "toxic", "psychic"],
	...
	dunsparce: {
		randomBattleMoves: ["coil", "rockslide", "bite", "headbutt", "glare", "bodyslam", "roost", "stealthrock", "playrough"],
	...
	granbull: {
		randomBattleMoves: ["thunderwave", "playrough", "crunch", "earthquake", "healbell", "firepunch"],
	...
	qwilfish: {
		randomBattleMoves: ["toxicspikes", "liquidation", "spikes", "painsplit", "thunderwave", "taunt", "destinybond", "swordsdance", "raindance", "poisonjab"],
	...
	heracrossmega: {
		randomBattleMoves: ["closecombat", "pinmissile", "rockblast", "swordsdance", "bulletseed", "substitute", "agility"],
	...
	weavile: {
		randomBattleMoves: ["iceshard", "iciclecrash", "knockoff", "pursuit", "swordsdance", "lowkick", "brickbreak"],
	...
	delibird: {
		randomBattleMoves: ["defog", "iceshard", "icepunch", "aerialace", "spikes", "destinybond", "icehammer", "toxicspikes", "spore", "imprison", "shellsmash", "thousandarrows", "v-create", "dragonacent"],
	...
	smeargle: {
		randomBattleMoves: ["spore", "stealthrock", "destinybond", "whirlwind", "stickyweb", "imprison", "toxicspikes"],
	...
	celebi: {
		randomBattleMoves: ["nastyplot", "psychic", "gigadrain", "recover", "healbell", "earthpower", "hiddenpowerfire", "leafstorm", "uturn", "thunderwave", "leechseed"],
	...
	linoone: {
		randomBattleMoves: ["bellydrum", "extremespeed", "stompingtantrum", "shadowclaw", "seedbomb", "brickbreak"],
	...
	shiftry: {
		randomBattleMoves: ["leafstorm", "swordsdance", "leafblade", "suckerpunch", "defog", "lowkick", "knockoff", "bodyslam", "fakeout"],
	...
	delcatty: {
		randomBattleMoves: ["doubleedge", "suckerpunch", "wildcharge", "fakeout", "thunderwave", "healbell", "cut"],
	...
	cameruptmega: {
		randomBattleMoves: ["stealthrock", "fireblast", "earthpower", "ancientpower", "willowisp", "toxic", "stockpile"],
	...
	seviper: {
		randomBattleMoves: ["flamethrower", "sludgewave", "gigadrain", "darkpulse", "switcheroo", "swordsdance", "earthquake", "poisonjab", "suckerpunch", "crunch"],
	...
	solrock: {
		randomBattleMoves: ["stealthrock", "explosion", "rockslide", "reflect", "lightscreen", "willowisp", "morningsun", "earthquake", "zenheadbutt", "cosmicpower"],
	...
	dusknoir: {
		randomBattleMoves: ["willowisp", "shadowsneak", "icepunch", "painsplit", "substitute", "earthquake", "focuspunch", "hypnosis", "spectraltheif", "drainpunch"],
	...
	huntail: {
		...
		randomDoubleBattleMoves: ["shellsmash", "waterfall", "icefang", "batonpass", "suckerpunch", "protect", "crunch"],
		tier: "(PU)",
		doublesTier: "(DUU)",
	},
	gorebyss: {
		randomBattleMoves: ["shellsmash", "hydropump", "icebeam", "hiddenpowergrass", "substitute", "psychic"],
	...
	luvdisc: {
		randomBattleMoves: ["icebeam", "toxic", "sweetkiss", "protect", "scald", "heartswap"],
	...
	salamence: {
		randomBattleMoves: ["outrage", "fireblast", "earthquake", "dracometeor", "dragondance", "dragonclaw", "fly", "hydropump"],
	...
	bibarel: {
		randomBattleMoves: ["return", "liquidation", "swordsdance", "quickattack", "aquajet", "curse"],
	...
	luxray: {
		randomBattleMoves: ["thunderfang", "icefang", "voltswitch", "crunch", "superpower", "facade"],
	...
	pachirisu: {
		randomBattleMoves: ["nuzzle", "thunderbolt", "superfang", "toxic", "uturn", "partingshot", "wish", "icefang", "firefang", "protect"],
	...
	spiritomb: {
		randomBattleMoves: ["shadowsneak", "pursuit", "willowisp", "darkpulse", "rest", "sleeptalk", "foulplay", "calmmind", "powergem", "stoneedge"],
	...
	gigalith: {
		randomBattleMoves: ["stealthrock", "rockblast", "earthquake", "explosion", "stoneedge", "superpower", "rockpolish"],
	...
	klinklang: {
		randomBattleMoves: ["shiftgear", "return", "geargrind", "magnetrise", "substitute"],
	...
	braviary: {
		randomBattleMoves: ["bravebird", "superpower", "return", "uturn", "substitute", "rockslide", "bulkup", "roost", "bodyslam"],
	...
	meloetta: {
		randomBattleMoves: ["uturn", "calmmind", "psyshock", "hypervoice", "shadowball", "focusblast", "icebeam"],
	...
	aromatisse: {
		randomBattleMoves: ["wish", "protect", "moonblast", "aromatherapy", "reflect", "lightscreen", "sludgebomb", "calmmind", "toxicspikes", "hex"],
	...
	lycanrocmidnight: {
		randomBattleMoves: ["stoneedge", "stealthrock", "suckerpunch", "swordsdance", "firepunch", "crunch"],
	...
	tapubulu: {
		randomBattleMoves: ["woodhammer", "hornleech", "stoneedge", "superpower", "megahorn", "bulkup", "leechseed"],
